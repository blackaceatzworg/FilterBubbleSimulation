...
public class UserGlobalsAndPanelFactory extends AbstractReLogoGlobalsAndPanelFactory{
	public void addGlobalsAndPanelComponents(){
		addSliderWL("numConsumers", "Number of Consumers", 1, 1, 100, 50)
		addSliderWL("numProducers", "Number of Producers", 1, 1, 10, 5)
		addSliderWL("globalThreshold", "Interest threshold", 0.0, 0.1, 1, 0.2)
		addSliderWL("globalWillToRead", "Willingness to read", 1, 1, 100, 30)
		addMonitorWL("averageWillToRead", "Average Will To Read", 30)
